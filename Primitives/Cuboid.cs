...
namespace ECS.Primitives
{
    public class Cuboid : Shape 
    {
        ...
        public Cuboid(Game game, Vector3 position, ICamPerspective iCamPerspective) : base(game, position, iCamPerspective)
        {
        ...
        protected override void SetVertexBuffer()
        {
            ...
            {
                new VertexPositionColor(new Vector3(-1*Scale.X, 1*Scale.Y, 1*Scale.Z), Color.Red), // 0
                new VertexPositionColor(new Vector3( 1*Scale.X, 1*Scale.Y, 1*Scale.Z), Color.Blue), // 1
                new VertexPositionColor(new Vector3( 1*Scale.X,-1*Scale.Y, 1*Scale.Z), Color.Green), // 2
                new VertexPositionColor(new Vector3(-1*Scale.X,-1*Scale.Y, 1*Scale.Z), Color.Yellow), // 3
                new VertexPositionColor(new Vector3(-1*Scale.X, 1*Scale.Y,-1*Scale.Z), Color.Red), // 4
                new VertexPositionColor(new Vector3( 1*Scale.X, 1*Scale.Y,-1*Scale.Z), Color.Blue), // 5
                new VertexPositionColor(new Vector3( 1*Scale.X,-1*Scale.Y,-1*Scale.Z), Color.Green), // 6
                new VertexPositionColor(new Vector3(-1*Scale.X,-1*Scale.Y,-1*Scale.Z), Color.Yellow), // 7
            };
